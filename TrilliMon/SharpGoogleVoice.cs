...
namespace TrilliMon
{
    class SharpGoogleVoice : IDisposable
    {
        ...
        public bool ValidLogin()
        {
            ...
            return !loginResult.Contains(@"The username or password you entered is incorrect.");
        }
        ...
        private static byte[] PostParameters(IDictionary<string, string> parameters)
        {
            ...
            {
                paramStr += key + "=" + Uri.EscapeUriString(parameters[key]) + "&";
            }
